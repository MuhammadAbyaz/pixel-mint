...
export default function CreateCollectionClient({
  ...
  const [activeTab, setActiveTab] = useState<"create" | "my-collections">(
    "create",
  );
  ...
  return (
    <div className="relative min-h-screen w-full bg-black">
      <main className="px-4 sm:px-8 lg:px-[144px] pt-[131px] pb-[100px]">
        {/* Page Title */}
        <h1 className="text-white text-2xl font-semibold text-center mb-[80px]">
          Create Collection
        </h1>
        ...
        {activeTab === "create" && (
          <form onSubmit={handleSubmit} className="max-w-[1154px] mx-auto">
            ...
            <div className="mb-[71px]">
              <label className="text-white text-lg block mb-[17px]">
                Name *
              </label>
              <input
                type="text"
